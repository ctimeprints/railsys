...
<head>
	<meta charset="utf-8">
	<title>Trains Schedule Searching System</title>
					...
					<div class="box-content">
						...
						echo '</tr>
						  ...
						  while($row = mysql_fetch_array($result))
  							{
  							echo "<tr>";
  							echo '<td><a href="admin_searchresult.php?trainname='.$get_train_name.'&searchbtn=trainsearch">' . $get_train_name . '</a></td>';
  							echo '<td><a href="admin_searchresult.php?sitename='.$row['site_name'].'&searchbtn=sitesearch">' . $row['site_name'] . '</a></td>';
  							if ($row['next_day'] == 0) {
  								echo "<td>当天</td>";
  							}else {
					...
					<div class="box-content">
						...
						echo '</tr>
						  ...
						  while($row = mysql_fetch_array($result))
  							...
  							echo "<tr>";
  							echo '<td><a href="admin_searchresult.php?sitename='.$row['site_name'].'&searchbtn=sitesearch">' . $row['site_name'] . '</a></td>';
  							echo '<td><a href="admin_searchresult.php?trainname='.$row['train_name'].'&searchbtn=trainsearch">' . $row['train_name'] . '</a></td>';
  							echo "<td>" . $row['in_time'] . "</td>";
  							echo "<td>" . $row['out_time'] . "</td>";
							...
							$get_site_name = $trainname_row['site_name'];
						  	echo '<td><a href="admin_searchresult.php?sitename='.$get_site_name.'&searchbtn=sitesearch">' . $get_site_name . '</a></td>';
					...
					<div class="box-content">
						...
						echo '</tr>
						  ...
						  while($row = mysql_fetch_array($result))
  							...
  							echo '<td><a href="admin_searchresult.php?sitename='.$row['site_name_1'].'&searchbtn=sitesearch">' . $row['site_name_1'].'</a><br><a href="admin_searchresult.php?sitename='.$row['site_name_2'].'&searchbtn=sitesearch">'.$row['site_name_2']. '</a></td>';
